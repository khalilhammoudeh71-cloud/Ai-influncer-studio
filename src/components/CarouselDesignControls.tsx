...
export default function CarouselDesignControls({slide,photos,onChange,onPanorama,photosOnly=false}:{photosOnly?:boolean;slide:CarouselSlide;photos:string[];onChange:(s:Partial<CarouselSlide>)=>void;onPanorama:()=>void}){
 ...
 {(slide.layout==='split'||slide.layout==='scrapbook')&&<CarouselPhotoPicker label="Second photo" photos={photos} value={slide.secondImage} onChange={secondImage=>onChange({secondImage})} emptyLabel="Repeat first photo"/>}
