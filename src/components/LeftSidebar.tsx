      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5 custom-scrollbar">
              ...
              {openAccordions.studio && (
                ...
                >
                  {[
                    ...
                    { id: 'stitcher', label: 'Video Editor', icon: Film }
                  ].map((sub) => {
                    return (
                      <button
                        key={sub.id}
        ...
        <div className="pt-4 border-t border-white/5 space-y-1">
          ...
          <button
            ...
            className={cn(
              "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-bold transition-all relative border",
              activeTab === 'trends' ? "text-cyan-400 bg-cyan-500/5 border-cyan-500/10 shadow-[0_0_15px_rgba(34,211,238,0.05)]" : "text-zinc-350 hover:text-white hover:bg-white/[0.02] border-transparent"
            )}
          >
            <TrendingUp size={16} />
