        ...
        <header className="sticky top-0 z-20 bg-[#1c1d22]/95 backdrop-blur-xl border-b border-white/[0.09] px-4 sm:px-5 py-2.5">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
              ...
              <button type="button" onClick={()=>{setControlsTab('voice');setShowEngineSettings(true);}} className="flex min-h-11 items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-medium text-zinc-200 hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-[#E7C477]"><SlidersHorizontal size={16}/>Settings / Controls</button>
              <button type="button" aria-label="New conversation" title="New conversation · keep saved history" disabled={isCallActive || isGenerating} onClick={()=>void resetConversation(activePersona)} className="flex size-11 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-zinc-300 hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-[#E7C477] disabled:opacity-40"><Plus size={17}/></button>
              <button type="button" aria-label="Delete conversation" title="Delete conversation history" disabled={isCallActive || isGenerating} onClick={()=>{if(window.confirm('Delete this persona’s conversation history? Saved memories and voice settings will stay.')) clearHistory();}} className="flex size-11 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-zinc-400 hover:bg-rose-500/10 hover:text-rose-300 focus-visible:ring-2 focus-visible:ring-[#E7C477] disabled:opacity-40"><Trash2 size={17}/></button>
